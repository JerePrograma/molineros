...
public class SacarConceptoComprobantesExtendidoAction extends PortletAction {
	...
	public ActionForward render(ActionMapping mapping, ActionForm form,
		...
		int indexCompConceptoComp = lista.indexOf(new ComprobanteConcepto(cc,centroCosto,tasaIva,new BigDecimal(importe)));
