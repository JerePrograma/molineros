...
public class BuscarReintegrosAction extends PortletAction {
	...
	public void processAction(ActionMapping mapping, ActionForm form,
		...
		setForward(actionRequest,
				"portlet.liquidaciones.reintegros.result.search");
	}
	...
	public ActionForward render(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if (tipo_reintegro
				...
				renderRequest.removeAttribute(WebKeysLiquidaciones.BUSQUEDA_REINTEGRO);
				renderRequest.setAttribute(WebKeysLiquidaciones.BUSQUEDA_REINTEGRO,  busqueda);
		...
		return mapping
				.findForward("portlet.liquidaciones.reintegros.result.search");
	}
}