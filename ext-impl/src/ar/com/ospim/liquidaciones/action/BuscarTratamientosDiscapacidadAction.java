...
/**
 * <a href="BuscarTratamientosDiscapacidadAction.java"><b><i>View
 * Source</i></b></a>
 * <p>
 * Realiza la búsqueda de tratamientod de discapacidad según parámetros de
 * entrada
 * 
 * @author Carlos Rivas
 * 
...
public class BuscarTratamientosDiscapacidadAction extends PortletAction {
	...
	public void processAction(ActionMapping mapping, ActionForm form,
		...
		setForward(actionRequest,
				"portlet.liquidaciones.discapacidad.result.search");
	}
	...
	public ActionForward render(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			List<TratamientoDiscapacidad> busqueda = TratamientoDiscapacidadServiceUtil
					.buscarTratamientosDiscapacidad(entidad, fechaDesde, fechaHasta, nroAfi, inte, cuil_titular, 0, 0, codPrest, prestador,
							numero, estado, codPrestaci,antiguos);
			renderRequest
		...
		return mapping
				.findForward("portlet.liquidaciones.discapacidad.result.search");
	}
}