...
//		prestador.setId_seccional(rs.getInt(prefix + "id_seccional"));
		...
		prestador.setAlta_fecha(rs.getTimestamp(prefix + "alta_fecha"));
		prestador.setAlta_usr(rs.getString(prefix + "alta_usr"));
		prestador.setModi_fecha(rs.getTimestamp(prefix + "modi_fecha"));
		prestador.setModi_usr(rs.getString(prefix + "modi_usr"));
		prestador.setBaja_fecha(rs.getTimestamp(prefix + "baja_fecha"));
