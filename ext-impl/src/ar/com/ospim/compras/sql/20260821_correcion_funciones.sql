...
/* ============================================================
 * 1. VALIDACION CANONICA DEL DETALLE
 * ============================================================ */
...
END IF;
     ...
     *
     * ENVIADO A COTIZAR:
     *   permite borrar si queda al menos un detalle activo.
     *
     * Otros estados:
     *   bloqueados.
     * ======================================================== */
...
END IF;
        ...
        /*
         * La baja solamente puede alterar:
         *
         * baja_fecha
         * baja_usr
         * modi_fecha
...
END IF;
        ...
        /*
         * En estado 2 se toma lock sobre la cabecera para
         * serializar bajas concurrentes del mismo requerimiento.
         */
...
END IF;
        ...
        /*
         * La baja ya fue completamente validada.
         *
         * No debe continuar por las reglas estructurales
         * de A COTIZAR, porque precisamente baja_fecha /
         * baja_usr cambiaron deliberadamente.
         */
...
END IF;
    ...
    IF TG_OP = 'UPDATE' THEN
        ...
        ELSIF v_estado = 2 THEN
            ...
            /*
             * En A COTIZAR sólo puede cambiar la información
             * correspondiente a cotización.
             *
             * Una baja válida ya retornó anteriormente.
             */
...
END IF;
    ...
    /*
     * Primero se obtiene el requerimiento padre.
     */
...
END IF;
     ...
     *
     * - baja vs baja;
     * - baja vs cierre de cotizacion;
     * - baja vs cambio de estado.
     */
...
END IF;
    ...
    /*
     * Después del padre se bloquea el detalle concreto.
     */
...
END IF;
    ...
    /*
     * ENVIADO A COTIZAR debe conservar al menos
     * un detalle activo.
     */
