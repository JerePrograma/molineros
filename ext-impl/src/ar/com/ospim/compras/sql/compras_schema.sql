...
END IF;
    ...
    /*
     * No se cambia el estado si no existe al menos un env�o
...
END IF;
    ...
    /*
     * La autorizaci�n se vuelve a comprobar en base de datos.
