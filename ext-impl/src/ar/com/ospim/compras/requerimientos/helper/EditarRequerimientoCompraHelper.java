...
public class EditarRequerimientoCompraHelper {
    ...
    private static final Log _log =
            LogFactoryUtil.getLog(EditarRequerimientoCompraHelper.class);
    ...
    public int guardarNuevoRequerimientoCompraConOrdenesMedicas(
        ...
        try {
            ...
            for (int i = 0; i < ordenesMedicas.size(); i++) {
                ...
                int idDocumento =
                        persistence.registrarOrdenMedica(
                                con,
                                idRequerimiento,
                                ordenMedica,
                                documento,
                ...
                if (idDocumento <= 0) {
                    throw new SQLException(
                            "La función de Orden médica devolvió "
    ...
    public int guardarDetalle(
        ...
        try {
            ...
            if (idDetalleGuardado <= 0) {
                throw new SQLException(
                        "La función de guardado devolvió "
                                + "un identificador de detalle inválido."
                );
            }
        ...
        try {
            ...
            if (resultado == null) {
                throw new IllegalStateException(
                        "El proceso de notificación no devolvió resultado."
                );
            }
    ...
    private void validarDetalleParaGuardar(
        ...
        if (WebKeysCompras.isEmpty(tipoItem)) {
            throw errorUsuario(
                    "Debe seleccionar el tipo de ítem."
            );
        }
        ...
        if (!RequerimientoCompraDetalle
            ...
            throw errorUsuario(
                    "El tipo de ítem seleccionado no es válido."
            );
        }
    ...
    private void validarTextoTecnico(
        ...
        if (recibidoNormalizado == null
            ...
            throw errorUsuario(
                    "El " + campo
                            + " cambió o ya no coincide con la información actual. Vuelva a seleccionarlo."
            );
        }
    }
    ...
    private RequerimientoCompra validarRequerimientoParaEnviarACotizar(
        ...
        if (!requerimiento.puedeEnviarACotizar()) {
            throw errorUsuario("El requerimiento solo puede enviarse a cotizar mientras está PENDIENTE.");
        }
    ...
    private GuardadoCotizacionResultado guardarCotizacion(
        ...
        try {
            ...
            for (int i = 0; i < detalles.size(); i++) {
                ...
                idsDetalle[i] =
                        Integer.valueOf(detalle.getIdInt());
            ...
            if (estadoFinal != WebKeysCompras.ESTADO_A_COTIZAR
                ...
                throw new SQLException(
                        "La función de cotización devolvió "
                                + "un estado inválido: "
                                + estadoFinal
                );
            }
    ...
    public int registrarPresupuesto(
        ...
        try {
            ...
            if (id <= 0) {
                throw new SQLException(
                        "La función de presupuesto devolvió "
                                + "un identificador inválido."
                );
            }
    ...
    /**
     * Único punto de salida para fallas técnicas de esta implementación.
    ...
    private String traducirSQLException(
        ...
        if (clave.contains(
            ...
            return "El requerimiento ya no está disponible o fue dado de baja.";
        }
        ...
        if ("23503".equals(sqlState)) {
            return "No se pudo completar la operación porque uno de los "
                    + "datos relacionados ya no existe o está siendo utilizado.";
        }
        ...
        if ("40001".equals(sqlState)
            ...
            return "La información cambió mientras se procesaba la operación. "
                    + "Actualice la pantalla y vuelva a intentarlo.";
        }

        if ("57014".equals(sqlState)) {
            return "La operación demoró más de lo esperado. Intente nuevamente.";
        }
