package ar.com.ospim.httpclient.ssl;
 ...
 *         </p>
 */
public class StrictSSLProtocolSocketFactory implements
		SecureProtocolSocketFactory {

	private static Log LOG = LogFactoryUtil.getLog(XLSServlet.class);
	...
	public boolean equals(Object obj) {
		if ((obj != null)
				&& obj.getClass().equals(StrictSSLProtocolSocketFactory.class)) {
			return ((StrictSSLProtocolSocketFactory) obj)
					.getHostnameVerification() == this.verifyHostname;
		} else {
			return false;
		}
	}
