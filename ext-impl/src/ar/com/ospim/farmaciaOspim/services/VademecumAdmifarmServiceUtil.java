...
public class VademecumAdmifarmServiceUtil {
    private static final VademecumAdmifarmServiceImpl service = new VademecumAdmifarmServiceImpl();
    ...
    public static ImportacionVademecumAdmifarm importar(String tipo, List<Registro> registros) throws Exception {
        return service.importar(tipo, registros);
    }
    public static ImportacionVademecumAdmifarm getImportacion(String tipo, Timestamp fecha) throws Exception {
