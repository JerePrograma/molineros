...
//					Analizamos parentesco para evaluar si corresponde calcular fecha de baja futura
					if(afi.getParentesco() != null
						...
						id_motivo_baja_menor_edad = 4;  //"MAYOR DE 21 A�OS NO ESTUDIANTE    "
					...
					if(afi.getParentesco() != null
						...
						id_motivo_baja_menor_edad = WebKeysAfiliados.HIJO_MAYOR;  //"MAYOR DE 21 A�OS NO ESTUDIANTE    "
...
//						hasta la fecha fin que ten�a,
//						luego metemos una terceriz En Tr�mite hasta el corte de sept 2016, 
...
//							ats.setFechaFinPres(fechaFinPresOriginal.getTime());
							...
							tercerizadoras_recup.add(atsAjuste);
							 ...
							 if(ats.getTercerizadora().getId_tercerizadora().equalsIgnoreCase("OMI") || //Omint
							   ...
							   corteInicio.add(Calendar.DATE, -1); //corte FIN!!
							   atsSandwich = new AfiTercerizadoraServicio("ETR", "En Tr�mite", corteInicioAux.getTime(), corteInicio.getTime());
