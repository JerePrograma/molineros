...
public class HistoricoAporteAction extends PortletAction {
	...
	public ActionForward render(ActionMapping mapping, ActionForm form,
		...
		try {
			lista = PlanServiceUtil.getInstance().historicoPlanyAportes(cuil_titular);

			renderRequest.setAttribute(WebKeysAfiliados.HISTORICO_APORTES,lista);
		...
		return mapping.findForward(getForward(renderRequest,
				"portlet.historico.aporte.result.search"));
	}
