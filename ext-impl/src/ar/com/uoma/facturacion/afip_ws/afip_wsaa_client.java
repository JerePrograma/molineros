...
public class afip_wsaa_client {
		...
		private static Logger logger = Logger.getLogger(afip_wsaa_client.class);
...
//			} catch (gov.afip.desein.dvadac.sua.view.wsaa.LoginFault e) {
...
//			System.out.println("TRA: " + LoginTicketRequest_xml);
			logger.info("TRA: " + LoginTicketRequest_xml);
