...
try{
	offset_reg=(Integer)session.getAttribute(WebKeysAutorizaciones.BUSQUEDA_TRATAMIENTOS_DISCAPACIDAD_OFFSET_REG );     // "offset_reg"
	total_reg =(Integer)session.getAttribute(WebKeysAutorizaciones.BUSQUEDA_TRATAMIENTOS_DISCAPACIDAD_TOTAL_REGISTROS );     // "total_registros"
...
<table class="lfr-table">
	...
	<tr>		
		...
		<td><select name="<portlet:namespace/>pagina_sel" id="<portlet:namespace/>pagina_sel"
				onchange="javascript:<portlet:namespace />busquedaTD();" >				
