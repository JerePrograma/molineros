CREATE OR REPLACE FUNCTION buscar_prestador_by_id(IN p_id integer)
  ...
  prs__contacto character varying, prs__id_seccional integer, prs__observaciones character varying, prs__rein_liqui smallint, 
  prs__id_condicion_de_iva smallint, prs__cheque_a_nombre_de character varying, prs__alta_fecha timestamp without time zone, 
  prs__alta_usr character varying, prs__modi_fecha timestamp without time zone, prs__modi_usr character varying, 
  prs__baja_fecha timestamp without time zone, prs__baja_usr character varying, prs__descripcion character varying, 
  dom__id_domicilio integer, dom__domi_tipo character varying, dom__calle character varying, dom__piso character varying, 
  dom__depto character varying, dom__oficina character varying, dom__postal_codi character varying, dom__barrio character varying, 
  dom__cod_area_telefono character varying, dom__telefono character varying, dom__cod_area_celular character varying, dom__celular character varying, 
