DROP FUNCTION buscar_comprobantes_orden_pago_amtima(p_id_op_amtima integer) ;
CREATE OR REPLACE FUNCTION buscar_comprobantes_orden_pago_amtima(p_id_op_amtima integer) 
...
and copo.id_orden_pago_amtima = $1;
