 CREATE OR REPLACE FUNCTION insertar_comprobante_op_amtima(
  c_pto_venta integer,
...
RETURNS integer
    ...
    declare ban integer;
  begin	
     	insert into comprobante_orden_pago_amtima (id_orden_pago_amtima, compro_tipo, compro_nro, id_punto_venta, cuit, compro_letra, compro_sucu)
