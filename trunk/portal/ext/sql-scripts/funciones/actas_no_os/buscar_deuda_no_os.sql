...
where ($1 is null or ($1 is not null and a.cuit = $1))
	and ($2 is null or ($2 is not null and upper(e.razon_soc) like upper($2)||'%'))	
	and acta_cerrada = false;
$BODY$
