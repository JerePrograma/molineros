...
public List<Detalle> procesarAsientoXLS(ActionRequest actionRequest,  File archivo,String fileName,String entidad,List<PlanCuentas>cuentas) throws Exception{
    User user = PortalUtil.getUser(actionRequest);
    List<String>errores = new ArrayList<String>();
