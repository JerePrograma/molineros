 ...
 */
public class ReporteOrdenPagoReintegrosFarmacia{

	private Afiliado afiliado;
	private ReintegroMedicamento reintegro;
	private BigDecimal total_afiliado;
	
	/**
	 * @return the id_reintegro
	 */	
	public ReporteOrdenPagoReintegrosFarmacia() {
	}
    
	public ReporteOrdenPagoReintegrosFarmacia(BigDecimal total_afiliado) {
	...
	public void setReintegro(ReintegroMedicamento reintegro) {
		this.reintegro = reintegro;
	}

	public ReintegroMedicamento getReintegro() {
		return reintegro;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReporteOrdenPagoReintegrosFarmacia other = (ReporteOrdenPagoReintegrosFarmacia) obj;
		if (reintegro == null) {
