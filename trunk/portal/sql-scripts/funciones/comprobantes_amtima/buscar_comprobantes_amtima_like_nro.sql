...
DROP FUNCTION buscar_comprobantes_amtima_like_nro(p_pto_vta numeric,
 p_tipo character varying,
 p_nro character varying,
 p_cuit character varying,
 p_letra character varying,
 p_sucu integer
) ;
CREATE OR REPLACE FUNCTION buscar_comprobantes_amtima_like_nro(p_pto_vta numeric,
 p_tipo character varying,
 p_nro character varying,
 p_cuit character varying,
 p_letra character varying,
