-- Function: buscar_ultimo_nro_comprobante_amtima(character varying, character varying, character varying)

-- DROP FUNCTION buscar_ultimo_nro_comprobante_amtima(character varying, character varying, character varying);
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION buscar_ultimo_nro_comprobante_amtima(character varying, character varying, character varying) OWNER TO postgres;
