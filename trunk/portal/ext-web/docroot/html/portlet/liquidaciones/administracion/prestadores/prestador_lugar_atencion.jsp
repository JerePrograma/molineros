	...
	<table class="lfr-table" style="border-collapse: separate; border-spacing: 3px;">
		...
		<tr>
			...
			<td colspan="1" style="vertical-align: top">
				<liferay-util:include page='/html/portlet/liquidaciones/administracion/prestadores/busqueda_calle.jsp'>
...
<fieldset class="block-labels">
	...
	<table class="lfr-table" style="border-collapse: separate; border-spacing: 3px;">
		<tr>
			...
			<td align="right">
				<input type="button" value="Agregar Teléfono" <% if(!esEdicion){%> disabled="disabled" <% } %>
