...
<%
	...
	if(null!=ps){
		seccionales=(List<Seccional>)ps.getAttribute(WebKeysFarmacia.SECCIONALES_EN_SESSION_FARMACIA,PortletSession.APPLICATION_SCOPE);		
		if(null==seccionales || seccionales.size()==0){
		  seccionales=TraeListasServiceUtil.getSeccionalesFarmacia();
		  ps.setAttribute(WebKeysFarmacia.SECCIONALES_EN_SESSION_FARMACIA,seccionales,PortletSession.APPLICATION_SCOPE);		  		
		}
	}
