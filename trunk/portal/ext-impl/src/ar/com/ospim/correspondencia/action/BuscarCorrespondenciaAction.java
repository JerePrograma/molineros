...
public class BuscarCorrespondenciaAction extends PortletAction {
	...
	private static Log _log = LogFactoryUtil.getLog(BuscarCorrespondenciaAction.class);
	...
	public ActionForward render(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			long seguim_paquete = ParamUtil.getInteger(renderRequest, "seguim_paquete", 0);
			...
			String oblea = ParamUtil.getString(renderRequest, "nro_oblea",null);
			String estado_item = ParamUtil.getString(renderRequest, "estado_item",null);
			...
			List<ItemCorrespondenciaTotal> busqueda = CorrespondenciaServiceImpl
					.buscarCorrespondencia(edificio, fechaDesde, fechaHasta,
							numero_correspondencia, tipo_registro, paquete,
							seguim_paquete, tipo_envio, tipo_remitente, cuil, inte,
							...
							contenido, oblea, estado_item, pagina_sel);
			...
			session.setAttribute(WebKeysCorrespondencia.BUSQUEDA_CORRESPONDENCIA, busqueda);
		...
		return mapping.findForward("portlet.ospim.correspondencia.result.search");
