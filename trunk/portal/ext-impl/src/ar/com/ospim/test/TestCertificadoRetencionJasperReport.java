...
public class TestCertificadoRetencionJasperReport {
...
//	}
			...
			String reportName = "certificadoRetencion";
			Map<String, Object> parameters = new HashMap<String, Object>();
//			parameters.put("ID_ORDEN_PAGO","97201");	
			parameters.put("id_op_p", "94747");		
			parameters.put("entidad_p", String.valueOf(WebKeysGlobal.OSPIM));	
			// compiles jrxml
