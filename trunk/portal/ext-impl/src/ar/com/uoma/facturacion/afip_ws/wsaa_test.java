...
//			config.load(new FileInputStream("./wsaa_client.properties"));
			config.load(new FileInputStream("/home/sergio/workspace_produccion/portal/ext-impl/src/ar/com/uoma/facturacion/afip_ws/wsaa_client.properties"));
...
//		String endpoint = config.getProperty("endpoint","http://wsaahomo.afip.gov.ar/ws/services/LoginCms"); 
		String endpoint = config.getProperty("endpoint","https://wsaahomo.afip.gov.ar/ws/services/LoginCms?wsdl");
