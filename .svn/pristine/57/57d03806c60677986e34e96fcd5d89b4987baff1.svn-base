		...
		<tr>
			<td colspan="8">
				<div id="<portlet:namespace />lista_especialidades">
					<jsp:include page='/html/portlet/liquidaciones/administracion/prestadores/lista_especialidades_prestador.jsp' />
				</div>
			</td>
		</tr>
	</table>
		...
		<tr>
			<td colspan="7">
				<div id="<portlet:namespace />lista_matriculas">
 					<liferay-util:include page="/html/portlet/liquidaciones/administracion/prestadores/lista_matriculas_prestador.jsp">
