...
<liferay-ui:error exception="<%= PagoMayorQueComprobanteException.class %>" message="op-ospim-pagos-mayor-comprobantes" />
...
<table class="lfr-table" width="100%">
	...
	<tr>
		...
		<td colspan="5">
			<textarea rows="5" cols="80"  disabled="disabled"   id="<portlet:namespace />obs" name="<portlet:namespace />obs" ><%=ordenPago != null && ordenPago.getObservaciones() != null ? ordenPago.getObservaciones()  : ""%></textarea>
		</td>
	</tr>
	<tr>
		<td colspan="6">&nbsp;</td>
