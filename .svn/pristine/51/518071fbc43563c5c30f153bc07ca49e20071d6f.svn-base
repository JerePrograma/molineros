...
import ar.com.ospim.autorizaciones.beans.PatologiaSituacionMedica.ESTADOS;


public class PatologiasSituacionMedica   implements Serializable {
	...
	public PatologiasSituacionMedica    (){
		super();
	}
	


	public static PatologiasSituacionMedica getMapping(String prefix, ResultSet rs)
			throws SQLException {
		
		PatologiasSituacionMedica patologiasSituacionMedica = new PatologiasSituacionMedica();
		...
		patologiasSituacionMedica.setDiagnosticoCieX(rs.getString (prefix + "descripcionciex"));
		
		if ( rs.getString(prefix + "baja_fecha") != null) {
			patologiasSituacionMedica.setEstado( PatologiasSituacionMedica.ESTADOS.BAJA  );		
			}			
	...
	public void setFechaBaja(java.sql.Date date) {
		this.fechaBaja = date;
	}
