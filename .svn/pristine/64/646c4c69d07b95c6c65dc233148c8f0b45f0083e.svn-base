...
public class BuscarOrdenesPagoOspimAction extends PortletAction {
	private static Log _log = LogFactoryUtil
			.getLog(BuscarOrdenesPagoOspimAction.class);

	public void processAction(ActionMapping mapping, ActionForm form,
			PortletConfig portletConfig, ActionRequest actionRequest,
			ActionResponse actionResponse) throws Exception {
		setForward(actionRequest,
				"portlet.liquidaciones.ordenes_pago_ospim.result.search");
	}
	...
	public ActionForward render(ActionMapping mapping, ActionForm form,
		...
		return mapping
				.findForward("portlet.liquidaciones.ordenes_pago_ospim.result.search");
	}
}