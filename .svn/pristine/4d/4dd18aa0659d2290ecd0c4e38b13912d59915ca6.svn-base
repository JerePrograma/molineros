...
drop function reporte_actas(p_fecha_ini date, p_fecha_fin date) ;
-- Function: reporte_actas(date, date)

-- DROP FUNCTION reporte_actas(date, date);

CREATE OR REPLACE FUNCTION reporte_actas(IN p_fecha_ini date, IN p_fecha_fin date)
