...
<form action="<%=portletURL%>" method="get"
 ...
 <fieldset class="block-labels">
		...
		<tr>	
			<td><label><liferay-ui:message key="codigo-farmacia" />:&nbsp;&nbsp;</label></td>
			<td>			 
			 <input id="<portlet:namespace />codFarmacia" name="<portlet:namespace />codFarmacia" size="20" maxlength="16" type="text" value="" />
			</td>
			<td colspan="12">&nbsp;</td>
			<td colspan="12">&nbsp;</td>		 
...
<script type="text/javascript">
	...
	function <portlet:namespace />busquedaFarmaciaOpsim(nroPagina){
		...
		var codFarmacia=jQuery('#<portlet:namespace />codFarmacia').val();
		...
		'&farmaciaDescripcion='+farmaciaDescripcion+'&farmaciaLocalidad='+farmaciaLocalidad+'&farmaciaProvincia='+farmaciaProvincia+'&codFarmacia='+codFarmacia+'&pagina_sel='+pagina_sel;
