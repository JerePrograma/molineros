			...
			<%
					...
					if(null!=asiento && asiento.getDetalle()!=null){					
					 	...
					 	for (int i = 0; i < asiento.getDetalle().size(); i++) {
	                        ...
	                        row.addText(comp.getCentroCosto()!=null && comp.getCentroCosto().getId()!=null && comp.getCentroCosto().getId()!=0? 
	                        		 comp.getCentroCosto().getId().toString():"" );
	                        row.addText(comp.getCentroCosto()!=null && comp.getCentroCosto().getId()!=null && comp.getCentroCosto().getId()!=0?
	                        		comp.getCentroCosto().getDescripcion():"");
