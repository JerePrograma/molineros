...
<portlet:defineObjects/>	
			<%				
				...
				if(null!=empresa && empresa.getContactosPorNombreApe()!=null){
					/* contactos=empresa.getContactos(); */
					for(Contacto c:empresa.getContactosPorNombreApe()){
						if(c.getNombreApe()==null || "".equalsIgnoreCase(c.getNombreApe())){
						   contactos.add(c);
						}
					}
//					  contactos=empresa.getContactosPorNombreApe() ;
				}
