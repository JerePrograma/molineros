create table uoma.domicilio_correspondencia (id_domicilio integer NOT NULL DEFAULT nextval('uoma.domicilio_uoma_corr_id_seq'::regclass),
  ...
  CONSTRAINT pk_domicilio_corresp_uoma PRIMARY KEY (id_domicilio ))
