CREATE OR REPLACE FUNCTION reporte_aportes_contrib_empresa_periodo_s(cuit_p character varying, periodo_desde date, periodo_hasta date, cuil_v character varying)
...
RAISE INFO 'ACTUALIZAR APELLIDO Y NOMBRE';
update temp_reporte_estudio t
...
RAISE INFO 'ACTUALIZAR FECHA RECAUDA';
update temp_reporte_estudio t
set fecha_recauda=(select max(o2.fecha_recauda)
                   from os_aportes_detalle o2
                   where o2.cuit_contribuyente=t.cuit_contribuyente
                   and o2.periodo=t.periodo);
