...
function <portlet:namespace />buscarSeccionalReintegro() {
    ...
    var url = '<portlet:renderURL windowState="<%= LiferayWindowState.EXCLUSIVE.toString() %>"/>&struts_action=/farmacia/buscar_seccional_reintegros&id_seccional='+id_seccional_r+
