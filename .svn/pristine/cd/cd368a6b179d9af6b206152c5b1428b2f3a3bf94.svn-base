		...
		try {
			...
			for (int i = 1; i <= cantidad; i++) {
				if (StringUtils.isNotBlank(actionRequest.getParameter("pase_"
					...
					String haberString = actionRequest.getParameter("haber_"
							+ i);
