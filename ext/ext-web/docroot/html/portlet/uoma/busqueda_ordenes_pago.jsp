...
<script type="text/javascript">
	...
	jQuery('#<portlet:namespace />buscar').click(function(){
		...
		var url = '<portlet:renderURL windowState="<%= LiferayWindowState.EXCLUSIVE.toString() %>"/>&struts_action=/<%=portlet_name%>/buscar_ordenes_pago&numero='+numero+'&cheque_numero='+chequeNumero;
		...
		url=url+'&cuit='+cuit+'&sucu='+sucu+'&idSeccional='+idSeccional;		
	...
	function <portlet:namespace />altaOP() {
		var url = '<portlet:renderURL windowState="<%= WindowState.MAXIMIZED.toString() %>"/>&struts_action=/<%=portlet_name%>/editar_orden_pago_entry';		
