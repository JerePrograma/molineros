...
<%
  ...
  session.setAttribute("CTACTE_RESULT_NAV", "0");
%>
					...
					if(null!=ctacteList){
					 	...
					 	for (int i = 0; i < ctacteList.size(); i++) {
							...
							rowURL.setWindowState(LiferayWindowState.MAXIMIZED);
					 		...
					 		sbRs.append(ctacte.getRazSoc());
					 		if (sbRs.length() > 15)
					 			row.addText(sbRs.substring(0,15));
					 		else
					 			row.addText(sbRs.toString());
                            ...
                            //StringBuilder sbBol = new StringBuilder();
					 		//sbBol.append(ctacte.getMontoBoletas_BD().toString());
