...
<portlet:defineObjects/>
		...
		<table class="lfr-table">
			...
			jQuery("#<portlet:namespace />exportar_v1").show();
			
			jQuery("#<portlet:namespace />exportar_actas_uoma").show();	
			jQuery("#<portlet:namespace />exportar_actas_amtima").show();	
			
			jQuery("#<portlet:namespace />exportar_v2").hide();						
			jQuery("#<portlet:namespace/>nav").val("2");
