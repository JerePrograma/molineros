...
<portlet:defineObjects/>
			...
			boolean showABMButtons = PermissionUtil.userContainsRole(user,WebKeysTesoreria.ROL_ABM_TESORERIA)||
			                         PermissionUtil.userContainsRole(user,WebKeysTesoreria.ROL_ABM_TESORERIA_UOMA)||
			                         PermissionUtil.userContainsRole(user,WebKeysUOMA.ROL_FACTURACION_MANUAL)
			                         ;
			List<FacturaIngreso> ingresos= null;
			if (factura != null ){
				ingresos = factura.getIngresos();
			}
