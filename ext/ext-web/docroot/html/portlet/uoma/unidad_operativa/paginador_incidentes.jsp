...
try{
	...
	if(total_reg == null && offset_reg == null){
		BusquedaIncidentesUnidadOpeFiltro f = (BusquedaIncidentesUnidadOpeFiltro) session.getAttribute(WebKeysUnidadOperativa.BUSQUEDA_INCIDENTES);
...
<table class="lfr-table">
	...
	<tr>
		...
		<td><select name="<portlet:namespace/>pagina_sel" id="<portlet:namespace/>pagina_sel" 
				onchange="javascript:<portlet:namespace />buscarIncidentes();" >
