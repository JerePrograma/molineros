...
try{
	...
	if(total_reg == null && offset_reg == null){
		BusquedaConsultasIGSFiltro f = (BusquedaConsultasIGSFiltro) session.getAttribute(WebKeysAfiliados.BUSQUEDA_CONSULTAS_IGS);
...
<table class="lfr-table">
	...
	<tr>
		...
		<td><select name="<portlet:namespace/>pagina_sel" id="<portlet:namespace/>pagina_sel" 
				onchange="javascript:<portlet:namespace />buscarConsultasIGS();" >
