		...
		<tr>
			...
			<td>
				<select name="<portlet:namespace />tipopedido" id="<portlet:namespace />tipopedido" >
					...
					<option value="EXCEPCION">EXCEPCI�N</option>
					<option value="REINTEGRO">REINTEGRO</option>
					<option value="EXTRACAPITA">EXTRAC�PITA</option>
				</select>					
			</td>
			<td>&nbsp;</td>
...
<!--  
<fieldset class="block-labels">				
	<legend> Exportar Im�genes</legend>		
   ...
   <table style="align: center;">
	<tr>
		...
		<td align="center">
		 ...
		 <input id="<portlet:namespace />exportar-imagenes" value="Exportar Im�genes" 
					title="Exportar Im�genes" type="button" />
		
		</td>
	</tr>
	<tr>
	<table><tr>
	<td><label style="color:blue" >Los n�meros de Reclamos deben estar separados por punto y coma</label></td>
	</tr></table>
	</tr>
   </table>	
...
function editarReclamoPrestacional(id_reclamo) {
	...
	function <portlet:namespace />initDateFields(){
		//capaz que seleccionar el afiliado del componente de b�squeda de afiliados		
	}
