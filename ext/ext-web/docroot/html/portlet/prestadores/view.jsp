...
<c:choose>
	<c:when test='<%= tabs1.equals("gestion-prestadores") %>'>	
		<liferay-util:include page="/html/portlet/prestadores/prestadores_admin_list.jsp"/>
	</c:when>
