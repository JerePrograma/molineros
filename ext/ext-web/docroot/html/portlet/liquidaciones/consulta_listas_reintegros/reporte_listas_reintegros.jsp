...
<portlet:defineObjects/>
		<fieldset class="block-labels">
			<legend><liferay-ui:message key="lista-reintegros" /></legend>
...
function <portlet:namespace />verLista(){
	...
	window.location.href ='/xlsservlet/?reporte=OP_REINTEGRO&idLista=' + trim(document.getElementById("<portlet:namespace />nro").value);
}
</script>
