		    ...
		    <tr>
		      <td><liferay-ui:message key="cobertura-expediente" /></td>
               ...
               <td>
				...
				<td>&nbsp;</td>
    			<td id="celdalabelmontoprevencion"><liferay-ui:message key="Monto Prevenci�n" /></td>				
...
//		jQuery('#<portlet:namespace />divTratamientosSeguimientoSur').show();
		...
		document.getElementById("<portlet:namespace />medicamentoProtesisSur").innerHTML="Prestaci�n";
		document.getElementById("<portlet:namespace />medicamentoProtesisSurBusqueda").innerHTML="Prestaci�n";
		...
		document.getElementById("<portlet:namespace />troquelProtesisSurBusqueda").innerHTML="C�digo";
...
function <portlet:namespace />agregarNuevaPatologia(){
   ...
   //if(popupPAT==null)
	   popupPAT = Liferay.Popup({title:"Nueva Patolog�a",modal:true,width:700});
