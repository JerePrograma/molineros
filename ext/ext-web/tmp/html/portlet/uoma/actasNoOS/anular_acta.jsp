...
<%
	...
	if (portlet_name == null || portlet_name.trim().equals("_EST_1")){
...
<script type="text/javascript">
 function <portlet:namespace />grabarAnulacionActa(){ 	
	...
	var url = '<portlet:renderURL windowState="<%= LiferayWindowState.EXCLUSIVE.toString() %>"/>&struts_action=/<%=portlet_name%>/borrar_actas_no_os_entry'
