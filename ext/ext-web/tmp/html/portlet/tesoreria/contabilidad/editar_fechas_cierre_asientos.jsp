...
<table style="width: 100%">
	<tr><td colspan="2"><b>Fecha cierre asientos</b></td></tr>
...
<script type="text/javascript">
	...
	function altaFechaAsiento(){
		...
		var url = '<portlet:actionURL windowState="<%= WindowState.MAXIMIZED.toString() %>"/>&struts_action=/<%=portlet_name%>/guardar_fecha_cierre_asientos';
