...
<%
	...
	if(esView){
		documLegal = (DocumentoLegalCRM) request.getAttribute(WebKeysCrm.CRM_DOCUM_LEGAL_EN_VIEW);
	}else{
		documLegal = (DocumentoLegalCRM) request.getSession().getAttribute(WebKeysCrm.CRM_DOCUM_LEGAL_EN_EDICION);
	}

	NoAfiliado crmNoAfi = documLegal!=null?documLegal.getNoAfiliado():null; 
%>
