...
public class Efectivo extends Ingreso {
	...
	public Efectivo(BigDecimal importe) {
	...
	public String getTipo() {
		if (estado != null) {
			if (estado.getId() == Efectivo.Estado.REDONDEO) {
				return "Redondeo";
			} else if (estado.getId() == Efectivo.Estado.AFIP) {
				return "Ingresos AFIP";
			} else if (estado.getId() == Efectivo.Estado.QUITAS) {
				return "Descuentos y quitas";
			} else if (estado.getId() == Efectivo.Estado.MANUALES) {
				return "Ingresos x Btas. Manuales";
			}
		}
