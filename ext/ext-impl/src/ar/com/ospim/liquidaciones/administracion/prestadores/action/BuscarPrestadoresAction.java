 ...
 * <p>
 * Realiza la búsqueda de prestadores según parámetros de entrada
 * 
...
//					descripcion.replace("%20", " ");
		...
		return mapping.findForward("portlet.liquidaciones.administracion.prestadores.result.search");
	}
