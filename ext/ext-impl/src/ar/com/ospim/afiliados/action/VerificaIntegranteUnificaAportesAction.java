...
public class VerificaIntegranteUnificaAportesAction extends JSONAction {
...
//		String inte = req.getParameter("inte");
		...
		result = EditarAfiliadoServiceUtil.verificaIntegranteUnificaAportesGrupoFliar(cuil);
