...
public class ReportePadronesAction extends PortletAction {
	public ActionForward render(ActionMapping mapping, ActionForm form,
		...
		TraeListasServiceUtil.getTiposAporte(renderRequest);
		
		return mapping.findForward("portlet.afiliados.reporte_padrones");
	}
}
