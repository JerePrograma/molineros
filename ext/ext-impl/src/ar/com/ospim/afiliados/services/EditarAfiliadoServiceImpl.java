...
public class EditarAfiliadoServiceImpl {
	...
	public Afiliado getAfiliadoEntry(String cuil_titular, int inte,
		...
		try {
			...
			if (afiliados.size() > 1) {
				String cause = "Hay un problema de inconsistencia de datos, se ha encontrado m�s de un afiliado con esa clave primaria, "
						+ "el problema pudo ser causado porque no hay datos correctos relacionados con la vigencia de domicilios, "
						+ "esto se pudo inyectar por concurrencia, esto es v�lido solo hasta que se tengan en cuenta domicilios vigentes "
...
//			}
	...
	/**
	 * Metodo que aplica borrado l�gico de un afiliado a partir de la clave
	 * primaria, no borra el afiliado f�sicamente, solo lo da de baja
	 * 
	 * @throws NoSuchAfiliadoEntryException
	 * @throws SystemException
	 */
...
//			Inserta ingreso de legajo del afiliado
	...
	/**
	 * Metodo que sugiere el pr�ximo numero de integrante para un Cuil_titular
	 * dado
	 * 
	 * @throws SystemException
	 */
	 ...
	 * 
	 * @return si no se encuentra ning�n afiliado vigente, retorna rulo
	 */
