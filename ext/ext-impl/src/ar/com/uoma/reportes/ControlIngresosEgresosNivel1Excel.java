...
public class ControlIngresosEgresosNivel1Excel extends ReporteXLS {
	...
	public static HSSFWorkbook generaReporte(HttpServletRequest req,
		...
		Map<String, ItemSubdiarioIngreso> reporte = (TreeMap<String, ItemSubdiarioIngreso>) req.getSession().getAttribute("CONTROL_INGRESOS_EGRESOS_EXPLOSION");
		
		return generarReporte(reporte,leyenda);
		
	}

	private static HSSFWorkbook generarReporte(Map<String, ItemSubdiarioIngreso>  reporte,String leyenda) {
...
//		wb.setRepeatingRowsAndColumns(0, 0, 7, 0, i - 1);
		...
		for (ItemSubdiarioIngreso repo : reporte.values()) {
