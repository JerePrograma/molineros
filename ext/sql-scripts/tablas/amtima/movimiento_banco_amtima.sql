CREATE TABLE movimiento_banco_amtima
(
  id_movimiento integer NOT NULL DEFAULT nextval('mov_bcrio_amtima_id_seq'::regclass),
  ...
  CONSTRAINT pk_mov_bco_amtima PRIMARY KEY (id_movimiento),
