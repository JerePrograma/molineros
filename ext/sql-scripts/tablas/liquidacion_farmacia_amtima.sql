CREATE TABLE liquidacion_farmacia_amtima (
    fecha timestamp without time zone NOT NULL,
    periodo timestamp without time zone NOT NULL,
    orden_pago_amtima_id integer NOT NULL,
...
ALTER TABLE public.liquidacion_farmacia_amtima OWNER TO postgres;

--
ALTER TABLE ONLY liquidacion_farmacia_amtima
    ADD CONSTRAINT fk_liqui_farma_amtima_op FOREIGN KEY (orden_pago_amtima_id) REFERENCES orden_pago_amtima(id_orden_pago);
