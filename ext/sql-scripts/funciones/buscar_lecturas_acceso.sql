...
--drop function buscar_lecturas_acceso(IN p_fecha_ini date, IN p_fecha_fin date, IN p_id_tarjeta_acceso character varying)

create function buscar_lecturas_acceso(IN p_fecha_ini timestamp without time zone, IN p_fecha_fin timestamp without time zone, IN p_id_tarjeta_acceso character varying)
