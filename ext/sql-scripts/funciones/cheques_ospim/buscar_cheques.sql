DROP FUNCTION buscar_cheques(cuit character,
 numero integer);
 
CREATE OR REPLACE FUNCTION buscar_cheques(cuit character,
...
ALTER FUNCTION public.buscar_cheques(cuit character,
 numero numeric, idbanco integer) OWNER TO postgres;
