CREATE OR REPLACE FUNCTION insertar_comprobante_amtima(c_pto_venta integer, c_compro_tipo character varying, c_compro_nro character varying,
...
$BODY$
    declare ban integer;
  begin	
	  insert into comprobante_amtima (
