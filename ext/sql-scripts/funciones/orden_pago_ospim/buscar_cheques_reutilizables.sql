CREATE OR REPLACE FUNCTION buscar_cheques_reutilizables() 
RETURNS TABLE(ch__nro_cheque numeric,
 ...
 ba__descripcion character varying)
	...
	select 	 distinct
	 ...
	 b.id_banco,
        b.descripcion 
	from orden_pago_ospim opo, orden_pago_ospim_pagos opop, cheque c, cheque_estado ce, banco b
	...
	and not exists (select 1 from orden_pago_ospim_pagos  opop2, 
...
ALTER FUNCTION public.buscar_cheques_reutilizables()  OWNER TO postgres;
