...
select opop.id,
	...
	c.nro_cheque,
     ...
     (select  opo2.id_orden_pago
			from orden_pago_ospim_pagos opop2, 
				orden_pago_ospim opo2 
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION buscar_orden_pago_ospim_pagos(integer) OWNER TO postgres;
