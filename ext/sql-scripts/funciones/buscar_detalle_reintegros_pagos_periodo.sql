--DROP FUNCTION buscar_detalle_reintegros_pagos_periodo(timestamp without time zone);

CREATE OR REPLACE FUNCTION buscar_detalle_reintegros_pagos_periodo(IN param_periodo timestamp without time zone)
  ...
  op_baja_ip character varying, r_id_reintegro integer, r_cuil_titular character varying, r_inte integer, 
  ...
  s_descripcion character varying, rp_id_prestacion integer, rp_id_prestador integer, rp_id_plan integer, 
  rp_fecha_prestacion timestamp without time zone, rp_cantidad numeric, rp_importe numeric, rp_compro_a_debitar_tipo character varying, 
  rp_compro_a_debitar_numero character varying, rp_tercerizado character varying, rp_cuit character varying, 
  rp_descripcion character varying, rp_alta_fecha timestamp without time zone, rp_alta_usr character varying, 
  rp_modi_fecha timestamp without time zone, rp_modi_usr character varying, pp_tope_cantidad smallint, pp_tope_importe numeric, 
  pp_tope_individ_cantidad smallint, pp_tope_individ_importe numeric, pp_id_prestacion integer, pp_id_plan integer, 
  n_id_especialidad integer, n_descripcion character varying, n_marca_rein_liq smallint, n_observaciones character varying, 
  n_alta_fecha timestamp without time zone, n_alta_usr character varying, n_modi_fecha timestamp without time zone, n_modi_usr character varying, 
...
--op
 ...
 lrpd.id_reintegro = r.id_reintegro and
 r.tipo_reintegro = 'pre' and 
