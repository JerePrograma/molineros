drop FUNCTION buscar_recibos(IN p_nro character varying, IN p_cuit character varying, IN p_empresa character varying);

CREATE OR REPLACE 
FUNCTION buscar_recibos(IN p_nro character varying, IN p_cuit character varying, IN p_empresa character varying)
