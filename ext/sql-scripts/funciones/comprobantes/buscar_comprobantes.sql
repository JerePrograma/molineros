DROP FUNCTION buscar_comprobantes(IN p_pto_vta numeric, IN p_tipo character varying, IN p_nro character varying, 
...
CREATE OR REPLACE FUNCTION buscar_comprobantes(IN p_pto_vta numeric, IN p_tipo character varying, IN p_nro character varying, 
IN p_cuit character varying, IN p_letra character varying, IN p_sucu integer, IN p_fecha_emision date, IN p_fecha_recepcion date,
IN p_periodo date, IN p_cuit_acreedor character varying, IN p_sucu_acreedor character varying, IN id_seccional integer)
  RETURNS TABLE(
