 ...
 * 
 * 
 * Si se modifica este sp, se debe modificar tambien cuenta_corriente_acreedores.sql
 */
------------ CUIDADO!!!! -------------------------
...
------IMPORTANTE-------- : Este stored trae la cta corriente a partir de el ultimo acreedores_saldo_inicial previo a p_fecha_ini, esto
-- se debe a que me pueden pedir la cta corriente de 01/08/2012 al 31/08/2012, pero tengo guardado un saldo inicial al ej: 31/07/2011
-- por lo tanto debo calcular el saldo inicial al 01/08/2012 calculado utilizando TODOS los registros a partir del saldo inicial guardado del 31/07/2011
CREATE OR REPLACE FUNCTION cuenta_corriente_acreedores_sin_cuit(IN p_fecha_ini date, IN p_fecha_fin date, IN p_fecha_pago date,  p_incluirProveedores boolean , p_incluirLiquidaciones boolean , p_incluirReintegros boolean)
...
begin
	...
	CREATE INDEX tmp_saldos_iniciales_index ON tmp_saldos_iniciales (cuit_acreedor, sucu_acreedor);
