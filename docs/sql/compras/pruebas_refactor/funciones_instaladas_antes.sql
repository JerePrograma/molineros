-- Evidencia de solo lectura. No ejecutar como migracion.
...
CREATE OR REPLACE FUNCTION compras.bloquear_requerimiento_reclamo_prestacional(p_id_requerimiento integer)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION compras.buscar_empresas_cotizacion(p_cuit character varying, p_descripcion character varying, p_sucursal character varying, p_limite integer)
 RETURNS TABLE(cuit character varying, sucursal character varying, razon_soc character varying)
 LANGUAGE sql
 STABLE
AS $function$
    SELECT
...
CREATE OR REPLACE FUNCTION compras.buscar_empresas_cotizacion_rapida(p_cuit character varying, p_descripcion character varying, p_sucursal character varying, p_limite integer)
 RETURNS TABLE(cuit character varying, sucursal character varying, razon_soc character varying)
 LANGUAGE plpgsql
 STABLE
AS $function$
...
CREATE OR REPLACE FUNCTION compras.buscar_requerimientos(p_estado integer, p_sector integer, p_afiliado_cuil_titular character varying, p_afiliado_int integer, p_id_tercerizadora character varying, p_recupero boolean, p_surge boolean, p_texto character varying)
...
CREATE OR REPLACE FUNCTION compras.buscar_requerimientos(p_estado integer, p_sector integer, p_afiliado_cuil_titular character varying, p_afiliado_int integer, p_id_tercerizadora character varying, p_recupero boolean, p_surge boolean, p_texto character varying, p_fecha_alta_desde date, p_fecha_alta_hasta date)
 RETURNS SETOF compras.requerimiento_base_row
 LANGUAGE plpgsql
 STABLE
AS $function$
...
CREATE OR REPLACE FUNCTION compras.finalizar_cotizacion_prestador(p_id_requerimiento integer, p_id_prestador integer, p_estado character varying, p_error text)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION compras.finalizar_notificacion_cotizacion_prestador(p_id_requerimiento integer, p_id_prestador integer, p_estado character varying, p_error text, p_usuario character varying)
 RETURNS TABLE(actualizado boolean, estado_anterior text, estado_actual text, motivo text)
 LANGUAGE plpgsql
AS $function$
...
CREATE OR REPLACE FUNCTION compras.finalizar_reclamo_prestacional(p_id_requerimiento integer, p_token_reserva character varying, p_id_reclamo_prestacional integer, p_usuario character varying)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION compras.get_estado_requerimiento_for_update(p_id_requerimiento integer)
 RETURNS integer
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION compras.get_pedido_cotizacion_prestador(p_id_requerimiento integer, p_id_prestador integer)
...
CREATE OR REPLACE FUNCTION compras.get_requerimiento_reclamo_prestacional(p_id_requerimiento integer)
...
CREATE OR REPLACE FUNCTION compras.guardar_cotizacion_requerimiento_call(p_id_requerimiento integer, p_ids_detalle_array character varying, p_precios_unitarios_array character varying, p_ids_detalle_eliminados_array character varying, p_id_prestador integer, p_surge boolean, p_usuario character varying)
 RETURNS integer
 LANGUAGE sql
AS $function$
...
CREATE OR REPLACE FUNCTION compras.guardar_requerimiento_detalle_clasificado(p_id integer, p_id_requerimiento integer, p_tipo_item character varying, p_id_prestacion integer, p_id_tipo_nomenclador integer, p_codigo_nomenclador character varying, p_descripcion_nomenclador character varying, p_id_medicamento integer, p_troquel integer, p_nombre_medicamento character varying, p_cantidad integer, p_observaciones text, p_id_tipo_prestacion integer, p_usuario character varying)
 RETURNS integer
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION compras.hay_prestadores_pendientes_notificacion(p_id_requerimiento integer)
 RETURNS boolean
 LANGUAGE plpgsql
 STABLE
AS $function$
...
CREATE OR REPLACE FUNCTION compras.liberar_reserva_reclamo_prestacional(p_id_requerimiento integer, p_token_reserva character varying, p_usuario character varying)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION compras.listar_prestadores_adjudicados(p_id_requerimiento integer)
...
CREATE OR REPLACE FUNCTION compras.listar_prestadores_notificacion_cotizacion(p_id_requerimiento integer)
 RETURNS TABLE(id_prestador integer, descripcion text, cuit text, email text, id_tipo_prestador integer, tipo_prestador text)
 LANGUAGE sql
 STABLE
AS $function$
SELECT
...
CREATE OR REPLACE FUNCTION compras.listar_relaciones_reclamo_prestacional_batch(p_estado character varying, p_ids_requerimientos text)
 RETURNS SETOF compras.requerimiento_reclamo_prestacional
 LANGUAGE sql
 STABLE
AS $function$
...
CREATE OR REPLACE FUNCTION compras.listar_relaciones_reclamo_prestacional_por_reclamo(p_id_reclamo_prestacional integer, p_estado character varying)
 RETURNS SETOF compras.requerimiento_reclamo_prestacional
 LANGUAGE sql
 STABLE
AS $function$
...
CREATE OR REPLACE FUNCTION compras.listar_tipos_prestacion()
 RETURNS TABLE(id_tipo_prestacion integer, descripcion character varying, id_sector integer, sector_descripcion character varying)
 LANGUAGE sql
 STABLE
AS $function$
    SELECT
...
CREATE OR REPLACE FUNCTION compras.marcar_error_reclamo_prestacional(p_id_requerimiento integer, p_token_reserva character varying, p_id_reclamo_prestacional integer, p_error text, p_usuario character varying)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION compras.normalizar_rubro(p_rubro character varying)
 RETURNS character varying
 LANGUAGE sql
 IMMUTABLE
AS $function$
...
CREATE OR REPLACE FUNCTION compras.normalizar_sector(p_descripcion character varying)
 RETURNS character varying
 LANGUAGE sql
 IMMUTABLE
AS $function$
...
CREATE OR REPLACE FUNCTION compras.normalizar_usuario(p_usuario character varying)
 RETURNS character varying
 LANGUAGE sql
 STABLE
AS $function$
...
CREATE OR REPLACE FUNCTION compras.registrar_pedido_cotizacion_documento(p_id_requerimiento integer, p_id_prestador integer, p_dl_group_id bigint, p_dl_folder_id bigint, p_dl_file_entry_id bigint, p_dl_file_uuid character varying, p_nombre_original character varying, p_nombre_persistido character varying, p_titulo character varying, p_usuario character varying)
 RETURNS integer
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION compras.resolver_email_cotizacion_prestador(p_id_prestador integer)
 RETURNS character varying
 LANGUAGE sql
 STABLE
AS $function$
...
CREATE OR REPLACE FUNCTION compras.tiene_situacion_medica_vigente(p_cuil_titular character varying, p_inte integer)
 RETURNS boolean
 LANGUAGE sql
 STABLE
AS $function$
...
CREATE OR REPLACE FUNCTION compras.validar_tipo_prestacion_detalle_fila()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
DECLARE
