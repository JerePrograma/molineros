...
-- El archivo está codificado en ISO-8859-1 y debe ejecutarse con psql:
-- psql -X -v ON_ERROR_STOP=1 -f 20260824_reparar_acentuacion_compras.sql
\encoding LATIN1
...
SET titulo = 'Orden médica'
WHERE tipo_documento = 2
  AND titulo IS DISTINCT FROM 'Orden médica';
