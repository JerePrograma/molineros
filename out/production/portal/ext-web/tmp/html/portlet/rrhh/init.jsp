...
<%@ page import="ar.com.ospim.rrhh.beans.RegistroAcceso" %>
<%@ page import="ar.com.ospim.rrhh.beans.TarjetaAcceso" %>
<%@ page import="ar.com.ospim.rrhh.beans.BusquedaTarjetasFiltro" %>
<%@ page import="ar.com.ospim.rrhh.WebKeysRrhh" %>
