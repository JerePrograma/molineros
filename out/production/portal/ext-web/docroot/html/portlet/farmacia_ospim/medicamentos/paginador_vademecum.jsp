...
try{
	offset_reg=(Integer)session.getAttribute(WebKeysFarmaciaOspim.FILTRO_BUSQUEDA_VADEMECUM_OFFSET_REG  );
	total_reg =(Integer)session.getAttribute(WebKeysFarmaciaOspim.TOTAL_DE_REGISTROS_BUSQUEDA_VADEMECUM );
...
<table class="lfr-table">
	<tr>
		...
		<td><select name="<portlet:namespace/>pagina_sel" id="<portlet:namespace/>pagina_sel"  
				onchange="javascript:<portlet:namespace />busquedaVademecum(1,false);" >				
