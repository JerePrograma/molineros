...
<%
	...
	CabeceraCorrespondencia  correspondenciaS=(CabeceraCorrespondencia) request.getSession().getAttribute(WebKeysCorrespondencia.SALIDA_EN_EDICION);

	if(correspondenciaS != null){
		itemsCorresp = correspondenciaS.getItemsCorrespondencia();
	}
