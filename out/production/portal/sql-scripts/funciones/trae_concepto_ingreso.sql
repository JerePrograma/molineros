 drop FUNCTION trae_concepto_ingreso(); 
CREATE OR REPLACE FUNCTION trae_concepto_ingreso(fecha date) 
...
ALTER FUNCTION public.trae_concepto_ingreso(fecha date) OWNER TO postgres;
