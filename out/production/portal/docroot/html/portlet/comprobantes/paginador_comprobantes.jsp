...
try{
	...
	offset_reg=(Integer)session.getAttribute(WebKeysComprobantes.COMPROBANTES_PROVEDORES_OFFSET_REG);     // "offset_reg"
	total_reg =(Integer)session.getAttribute(WebKeysComprobantes.COMPROBANTES_PROVEEDORES_TOTAL_REGISTROS);     // "total_registros"
