...
try{
	...
	offset_reg=(Integer)session.getAttribute(WebKeysEstudioIsidro.DEMANDAS_OFFSET_REG);     // "offset_reg"
	total_reg =(Integer)session.getAttribute(WebKeysEstudioIsidro.DEMANDAS_TOTAL_REGISTROS);     // "total_registros"
