...
<portlet:defineObjects/>
			<%	    			 				
					...
					List<PadronInformado> padrones= (ArrayList<PadronInformado>)renderRequest.getAttribute("ultimosLegajosProcesados");
					 	...
					 	for (int i = 0; i < padrones.size(); i++) {
					 		PadronInformado padron = (PadronInformado) padrones.get(i);
									...
									sb4.append("<img alt=\"<liferay-ui:message key='rendir'/>\" src=\"");
		 							...
		 							sb4.append("/common/print.png\" onClick=\"javascript:imprimirLegajosProcesoAnterior('");				 					
