...
<table class="lfr-table" style="border-collapse:separate; border-spacing: 2px; width: 100%;" > 
	<%-- <tr>
		...
		<td>	
			<select name="<portlet:namespace />profesionC" id="<portlet:namespace />profesionC">
		...
		<td>
			<input id="<portlet:namespace />cargoC" name="<portlet:namespace />cargoC" maxlength="50" type="text" style="width: 100px;"/>
		</td>
		<td>	
			<liferay-ui:message key="nombre"/>:
		</td>
		<td>	
			<input id="<portlet:namespace />apeynom" name="<portlet:namespace />apeynom" type="text" style="width: 300px;"/>
		</td>
		<td>
		&nbsp;
		</td>
	...
	<tr>
		<td colspan="7" align="center">
			<div align="center" id="<portlet:namespace />contactos">
				<liferay-util:include page="/html/portlet/empresas/contactos_search_result.jsp">											
...
function <portlet:namespace />showHideDivContactos(){		
	...
	function borraContacto(tipo, contactoC, idContactoC){
