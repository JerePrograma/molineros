...
<%
   NumberFormat format2D = new DecimalFormat("#0.00");
	...
	ComprobanteHospital comprobante=(ComprobanteHospital)request.getSession().getAttribute(WebKeysComprobantes.COMPROBANTE_GERENCIADORA_EN_EDICION);
...
function <portlet:namespace />salvarEdicion(){
	...
	if (<portlet:namespace />validarCampos()) {
		...
		'<liferay-portlet:param name="struts_action" value="/comprobantes/comprobantes_portal_proveedores_gerenciadoras" />'+
