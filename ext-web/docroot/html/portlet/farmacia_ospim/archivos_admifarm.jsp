...
archivos=FarmaciaServiceUtil.getArchivosSubidosAdmifarm(); 
 	...
 	for (int i = 0; i < archivos.size(); i++) {	    
		...
		row.addText(format2D.format(liq.getTotaluoma()));
	 	...
	 	StringBuilder sbo=new StringBuilder();
			...
			sbo.append(" onClick=\"javascript:exportacionAdmifarm('");
...
function exportacionAdmifarm(periodo){
    window.location.href ='/xlsservlet/?reporte=REPORTE_ARCHIVO_ADMIFARM_PERIODO'
        +'&periodo='+periodo;
}
</script>
