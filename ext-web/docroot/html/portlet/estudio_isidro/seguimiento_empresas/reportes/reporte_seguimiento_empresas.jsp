...
%>	
		<fieldset class="block-labels">
				<legend><liferay-ui:message key="reporte-seguimiento" /></legend>
				<table class="lfr-table">			
					...
					<tr>
						<td>
							<input id="<portlet:namespace />buscar" value="<liferay-ui:message key="buscar"/>" title="<liferay-ui:message key="buscar" />" type="button" onClick="javascript:<portlet:namespace />buscarLlamados();"/>
						</td>
					</tr>
				</table>	      	  
		</fieldset>	
...
function <portlet:namespace />buscarLlamados(){
	...
	var url = '/xlsservlet/?reporte=REPORTE_LLAMADOS_ESTUDIO' 
