...
<portlet:defineObjects/>
			<%
				...
				//Si debe mostrarse el btn de agregar afiliado								
					...
					List<Convenio> convenios= (ArrayList<Convenio>)portletSession.getAttribute(WebKeysTesoreria.BUSQUEDA_CONVENIOS);
					...
					if(null!=convenios){
					 	...
					 	for (int i = 0; i < convenios.size(); i++) {
					 		...
					 		if(renderResponse!=null && renderResponse.getNamespace()!=null && renderResponse.getNamespace().equals("_EST_1_")) {
					 			...
					 			String metodjava=null;
					 			if(null!=convenio.getEntidad()&& convenio.getEntidad().equals("OSPIM")){
					 				metodjava="<a href='javascript:popupConvenio(\"";
					 			}else{
					 				metodjava="<a href='javascript:popupConvenioNoOS(\"";
					 			}
					 			sb01.append(metodjava);
