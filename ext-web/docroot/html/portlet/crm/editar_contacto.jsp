...
function mostrarDomicilioAfiliado(cuil_titu, integ, idPar){  
	...
	&struts_action=/<%=portlet_name%>/actualiza_domicilio&
	cuil_titular='+cuil_titu+'&inte='+integ+'&id_parentesco='+idPar+'&cmd=view'+'&email='+encodeURI('<%=email%>');	
