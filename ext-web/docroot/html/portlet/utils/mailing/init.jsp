...
<%@ page import="ar.com.global.beans.ListaDestinatarios" %>
<%@ page import="ar.com.global.beans.Destinatario" %>
<%@ page import="ar.com.global.beans.Boletin" %>
<%@ page import="ar.com.global.beans.Contenido" %>
<%@ page import="ar.com.global.exceptions.EmailYaRegistradoException" %>
