	...
	<fieldset class="block-labels">
		...
		<table class="lfr-table">	
			<tr>
			  ...
			  <td style="background-color:#AEB6BF"><label>Uso Contable:</label>
			            <input type="checkbox"
						  id="<portlet:namespace />contable_filtro"
						  name="<portlet:namespace />contable_filtro" value="false">
			  </td>
		    </tr> 
...
<script type="text/javascript">
	...
	function <portlet:namespace />initDateFields(){
		...
		jQuery("#<portlet:namespace />contable_filtro").attr("checked", false);
	}
	...
	function <portlet:namespace />buscarCentro(){
		...
		var contable=jQuery("#<portlet:namespace/>contable_filtro").is(':checked');
		jQuery('#<portlet:namespace />buscandoCC').show();
		
	 	var busquedaCentroCosto = {"descripcioncentro":descripcion,"entidadcentro":<%=entidad%>,"id":id,"contable":contable};
