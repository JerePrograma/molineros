	...
	<table class="lfr-table" width="100%">
			...
			<table width="100%">
				<tr>
					...
					<td>
						<select id="<portlet:namespace />tipo_ingreso" name="<portlet:namespace />tipo_ingreso" onchange="changeTipo();">
							...
							<%if (portlet_name==null || portlet_name.equals("tesoreria")){%>							
				...
				<tr>
					...
					<span id="<portlet:namespace />numeroSpan2">
						<input type="text" value="" name="<portlet:namespace />nro" id="<portlet:namespace />nro" <%if(portlet_name.equals("uoma")){%>maxlength="8" size="9"<%}%>/>
		...
		<tr>
			...
			<div align="center" id="<portlet:namespace />ingresos">
				<jsp:include page='recibo_ingresos_search_result.jsp' />
			</div>
			</td>
		</tr>
	</table>
