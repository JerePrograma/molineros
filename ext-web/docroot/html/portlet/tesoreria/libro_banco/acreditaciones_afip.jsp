...
%>	
		<fieldset class="block-labels">
				<legend><liferay-ui:message key="grupo-filtro-busqueda-acreditaciones-afip" /></legend>
...
function <portlet:namespace />buscarMovimientos(){
	alert("El reporte solo incluirá datos hasta la fecha que se encuentre cargado el extracto bancario.");
	...
	var url = '/xlsservlet/?reporte=ACREDITACIONES_AFIP' 
