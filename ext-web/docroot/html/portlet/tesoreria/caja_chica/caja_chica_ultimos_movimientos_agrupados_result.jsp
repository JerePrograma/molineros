...
Map<String,Double> comprobantes= (Map<String,Double>) request.getSession().getAttribute(WebKeysCajaChica.COMPROBANTES_CAJA_CHICA_PENDIENTES_RENDICION_AGRUPADO);					
