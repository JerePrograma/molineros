...
<form action="" method="get" name="<portlet:namespace />fm" enctype="multipart/form-data"> 
	<fieldset class="block-labels">
		<legend>Lista de Bonificaciones-Ajustes</legend>
		...
		<table>
			 <tr align="left">
				...
				<td align="left" width="100%">						
					...
					onClick="javascript: <portlet:namespace />buscarAjuste();"
					type="button" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					  <input type="button" value="Nuevo" onClick="<portlet:namespace />nuevoAjuste();"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					 <input type="button" value="Reporte" onClick="<portlet:namespace />reporteAjustes();"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
-->	
	...
	<fieldset class="block-labels">
		...
		<div id="<portlet:namespace />ajustesDiv"
	     	style="
	        max-width: 1100px;
	        max-height: 400px;
	        overflow-x: auto;
	        ...
	        border-radius: 6px;
	        background: #fff;">
            <jsp:include page='/html/portlet/tesoreria/facturacion/facturacion_ajustes_result.jsp' />  
        </div>
...
<script type="text/javascript">
	...
	function <portlet:namespace />nuevoAjuste() {
	...
	function <portlet:namespace />buscarAjuste(){
		...
		jQuery('#<portlet:namespace />buscando').show();
	 	var busquedaNom = {"id_precio":id,"cmd":"filter","fechadesdedia":fechaDesdeDia.value,"fechadesdemes":fechaDesdeMes.value,
		                   "fechadesdeanio":fechaDesdeAnio.value,"plan":plan,"parentesco":parentesco,"provincia":provincia,
		                   "descripcion":descripcion,"cuil":cuil};

	 	var url = '<portlet:renderURL windowState="<%= LiferayWindowState.EXCLUSIVE.toString() %>"><portlet:param name="struts_action" value="/tesoreria/facturacion_ajustes" /></portlet:renderURL>';
		jQuery('#<portlet:namespace />ajustesDiv').load(url,busquedaNom, function(){
															jQuery('#<portlet:namespace />buscando').hide();      
		});	
		
	}
	
	function <portlet:namespace />reporteAjustes(){
		...
		var url = '/xlsservlet/?reporte=REPORTE_AJUSTES_FACTURACION';
	...
	function <portlet:namespace />generarAjustes(){
