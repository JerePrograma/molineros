...
%>
		<fieldset class="block-labels">
				<legend>Mayor General</legend>
				<table class="lfr-table">
					<tr>
						<td>Ejercicio:&nbsp; 
								<select name="ejercicio"  id="ejercicio" onchange="actualizarCuentas()">
				...
				<select name="periodo_hasta" id="periodo_hasta">
					...
					<tr>
						<td >
							...
							<input type="button" id="generar" onclick="generarDiario()" value="Generar Mayor General" /><a href="javascript:void(0)" onclick="help(event, 'helpGeneracion')"><img style="height: 16px; width: 16px" src="/html/images/help.png" title="Ayuda" alt="Ayuda"/></a>
						</td>
					</tr>
				</table>	      	  
		</fieldset>	
...
function generarDiario(){
	...
	jQuery.ajax({   
		...
		success: function(data){	
			...
			if (obj.status == "ok"){
				window.location.href ='/xlsservlet/?reporte=REPORTE_MAYOR_GENERAL'
