...
request.setAttribute(
        ...
        Boolean.valueOf(reclamoPersistido)
);
request.setAttribute(
        "rp.view.scripts.edicion",
        Boolean.valueOf(esEdicion)
);
request.setAttribute(
        "rp.view.scripts.cantPrestaciones",
        Integer.valueOf(cantprestacioneslista)
);
request.setAttribute(
        "rp.view.scripts.cantRevisiones",
        Integer.valueOf(cantRevisiones)
);
request.setAttribute(
...
request.setAttribute(
        ...
        Boolean.valueOf(debitoTercerizadora)
);
request.setAttribute(
        "rp.view.scripts.handoffCompras",
        Boolean.valueOf(handoffReclamoComprasValido)
);
request.setAttribute(
...
%>
<liferay-util:include
    page="/html/portlet/autorizaciones/reclamos_prestacionales/view_reclamo_scripts_inicial.jsp"
/>
<liferay-util:include
    page="/html/portlet/autorizaciones/reclamos_prestacionales/view_reclamo_scripts_revision.jsp"
/>
<liferay-util:include
    page="/html/portlet/autorizaciones/reclamos_prestacionales/view_reclamo_scripts_validaciones.jsp"
/>
<%
