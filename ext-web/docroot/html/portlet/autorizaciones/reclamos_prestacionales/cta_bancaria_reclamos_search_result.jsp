		...
		SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy HH:mm");
	 	...
	 	for (int i = 0; i < afiCuenta.size(); i++) {
	 		...
	 		*/
	 		...
	 		if (cuenta.isTitular()) {
	 		    // Titular: afiliadoTitular
	 		    if (afiliadoTitular != null &&
	 		        (Validator.isNotNull(afiliadoTitular.getApellido()) || Validator.isNotNull(afiliadoTitular.getNombre()))) {

	 		        apeNom = (afiliadoTitular.getApellido() != null ? afiliadoTitular.getApellido() : "") + " " +
	 		                 (afiliadoTitular.getNombre()  != null ? afiliadoTitular.getNombre()  : "");

	 		    } else {
	 		        //lo que viene de la cuenta
	 		        apeNom = (cuenta.getApellido() != null ? cuenta.getApellido() : "") + " " +
	 		                 (cuenta.getNombre()  != null ? cuenta.getNombre()  : "");
	 		    }

	 		} else {
	 		    // Apoderado: viene de la cuenta
	 		    apeNom = (cuenta.getApellido() != null ? cuenta.getApellido() : "") + " " +
	 		             (cuenta.getNombre()  != null ? cuenta.getNombre()  : "");
	 		}
...
function obtenerCuenta(idCuenta) {
	  ...
	  var params = "&<%= Constants.CMD %>=" + "<%=WebKeysAutorizaciones.CUENTA_SELECT%>";
