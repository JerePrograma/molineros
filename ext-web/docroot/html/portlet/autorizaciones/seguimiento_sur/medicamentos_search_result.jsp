...
<%
	...
	String clase=renderRequest.getParameter("clase");	
	String patologia=renderRequest.getParameter("patologia");
	//...	
	...
	headerNames.add("Id");
	headerNames.add("Troquel/Código");
	...
	if("ME".equalsIgnoreCase(clase)){
	   medicamentos =SeguimientoSurServiceUtil.getBusquedaMedicamentos(Integer.parseInt(troquel),nombre_medicamento,Integer.parseInt(patologia));
	}else if("PR".equalsIgnoreCase(clase) || "OT".equalsIgnoreCase(clase) || 
			 "HI".equalsIgnoreCase(clase) ||
			 "HE".equalsIgnoreCase(clase) ||
			 "DB".equalsIgnoreCase(clase)){
		medicamentos =SeguimientoSurServiceUtil.getBusquedaProtesisYOtros(Integer.parseInt(troquel),nombre_medicamento);	
	}else if("DR".equalsIgnoreCase(clase)){
		medicamentos =SeguimientoSurServiceUtil.getBusquedaDrogadependencia(Integer.parseInt(troquel),nombre_medicamento);
	}
	...
	//More de una coincidencia	
		...
		List resultRows = searchContainer.getResultRows();
	 	for (int i = 0; i < medicamentos.size(); i++) {
			...
			s.append("\",\"");
			s.append(medicamento.getPresentacion().trim());
			s.append("\")'>");		
			s.append(medicamento.getId_medicamentoAsString());
			s.append("</a>");
			...
			sb.append("\",\"");
			sb.append(medicamento.getPresentacion().trim());
			sb.append("\")'>");			
			sb.append(String.valueOf(medicamento.getTroquel()));
			sb.append("</a>");
			...
			sb2.append("\",\"");
			sb2.append(medicamento.getPresentacion().trim());
			sb2.append("\")'>");
			sb2.append(medicamento.getNombre());
			sb2.append("</a>");
			...
			sb3.append("\",\"");
			sb3.append(medicamento.getPresentacion());
			sb3.append("\")'>");
			sb3.append(medicamento.getPresentacion().trim());
			sb3.append("</a>");
			...
			sb4.append("\",\"");
			sb4.append(medicamento.getPresentacion());
			sb4.append("\")'>");
			sb4.append(medicamento.getCod_barra().trim());
			sb4.append("</a>");
			...
			sb5.append("\",\"");
			sb5.append(medicamento.getPresentacion());
			sb5.append("\")'>");
			sb5.append(medicamento.getPrecio().toString());
			sb5.append("</a>");
