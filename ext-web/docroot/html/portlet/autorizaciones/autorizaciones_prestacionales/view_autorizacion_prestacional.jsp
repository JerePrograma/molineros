...
<td><label>Prestador:</label></td>
	...
	<tr>				
		...
		<c:if
			...
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="submit"
				value="Autorización PDF y Envío Mail"
		...
		<c:if
			...
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="submit"
				value="Autorización PDF sin Envío de Mail"
				onClick="<portlet:namespace />imprimirAT_PDF();return false;" />
		</c:if>
             ...
             <div id="<portlet:namespace />crm_auditoria">
			 	<table style="font-size: 8">
						<tr>
							...
							<td>
							    <%if(tratamiento != null && tratamiento.isMailPrestadorEnviado() ){ %>
							       <span style="font-size: 13pt; color: blue; "><label>Mail Enviado </label></span>
							    <%}%>
							</td>
						</tr>
				</table>   
