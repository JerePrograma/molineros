...
/*
 * Las tres pestañas originales siempre están visibles.
 */
String tabNames =
...
/*
 * El histórico solamente tiene sentido para un prestador
 * que ya fue persistido.
 */
if (idPrestAux > 0) {
    tabNames +=
...
/*
 * Defensa ante una URL manual que intente abrir el histórico
 * de un prestador todavía no persistido.
 */
if (
    idPrestAux <= 0 &&
