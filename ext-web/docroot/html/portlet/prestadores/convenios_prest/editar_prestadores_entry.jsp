...
<%
    Prestador prestador = (Prestador) request.getAttribute(WebKeysLiquidaciones.PRESTADOR_EN_EDICION);

    if (prestador == null) {
        prestador = (Prestador) request.getSession().getAttribute(WebKeysLiquidaciones.PRESTADOR_EN_EDICION);
    }
    ...
    String tabValue = ParamUtil.getString(request, "tab");

    if (Validator.isNull(tabValue)) {
        tabValue = ParamUtil.getString(request, "tabs1");
    }
...
<% } else if ("plan_prest".equals(tabValue)) { %>
    ...
    <liferay-util:include page="/html/portlet/prestadores/prestador_plan.jsp" />
