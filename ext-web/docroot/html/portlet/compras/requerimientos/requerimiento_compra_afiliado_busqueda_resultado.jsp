<%--
Responsabilidad:
    Renderiza el resultado de búsqueda de afiliado para selección en Compras.
Incluido desde:
...
IDs o funciones JavaScript expuestos:
    sincronizarAfiliadoRequerimiento, actualizarVisibilidadAfiliado, mostrarMensajeAfiliadoInicial
Efectos secundarios:
