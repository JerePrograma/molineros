<%--
Responsabilidad:
    Renderiza la pantalla principal y listado de requerimientos.
Incluido desde:
    requerimiento_compra_cotizados.jsp
...
IDs o funciones JavaScript expuestos:
    estado, sector_id, afiliado_cuil_titular, afiliado_int, afiliado_tipo_doc, afiliado_nro_doc
Efectos secundarios:
