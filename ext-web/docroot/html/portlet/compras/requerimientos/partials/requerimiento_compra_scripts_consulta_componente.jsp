<%--
Responsabilidad:
    Declara interacción ES5 exclusiva de la vista de consulta.
Incluido desde:
    requerimiento_compra_scripts_consulta_runtime_componente.jsp
...
IDs o funciones JavaScript expuestos:
    setAfiliadoVistaValue, aplicarColorBajaAfiliadoVista, baja_fecha, bloquearComponenteAfiliadoVista, afiliado_requerimiento_panel, id_seccional, seccional, btnBuscarSeccional, buscarAfiliado, limpiarCampos, cargarAfiliadoVista
Efectos secundarios:
...
<script type="text/javascript">
    (function() {
        ...
        jQuery(function() {
             ...
             *
             * La función pertenece a requerimiento_compra_scripts_base_componente.jsp, que se carga
