<%--
Responsabilidad:
    Inicializa variables JSP desde atributos request para includes runtime.
Incluido desde:
    requerimiento_compra_acciones_runtime_componente.jsp, requerimiento_compra_adjudicacion_runtime_componente.jsp, requerimiento_compra_datos_basicos_runtime_componente.jsp, requerimiento_compra_mensajes_runtime_componente.jsp, requerimiento_compra_orden_medica_carga_runtime_componente.jsp, requerimiento_compra_orden_medica_consulta_runtime_componente.jsp, requerimiento_compra_scripts_base_componente.jsp, requerimiento_compra_scripts_consulta_runtime_componente.jsp, requerimiento_compra_scripts_edicion_afiliado_componente.jsp
