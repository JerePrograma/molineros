<%--
Responsabilidad:
    Renderiza mensajes funcionales y errores del flujo de Compras.
Incluido desde:
    requerimiento_compra_mensajes_runtime_componente.jsp
...
IDs o funciones JavaScript expuestos:
    alternarDetalleNotificacion, detalleNotificacion, enlaceDetalleNotificacion
Efectos secundarios:
