<%--
Responsabilidad:
    Inicializa y renderiza el modelo JavaScript de prestaciones y cotización.
Incluido desde:
...
IDs o funciones JavaScript expuestos:
    detallesCompra, detalleDeletedIds, prestadoresEnviadosDetalleCache, tiposPrestacionDetalleCache, sectorDescripcionInicialCompra, idPrestadorAdjudicado, prestadorAdjudicado, detalleEscapeHtml, detalleValue
Efectos secundarios:
