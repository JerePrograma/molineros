<%--
Responsabilidad:
    Renderiza la matriz sector, tipo de cotización y tipo de prestador.
Incluido desde:
...
IDs o funciones JavaScript expuestos:
    id_sector_selector, guardarConfiguracionPrestadoresForm, id_sector, cantidadTiposActivos, tipoPrestadorCheckbox, tipo_prestador_, tipo_prestador_cotizacion, guardarConfiguracionPrestadores
Efectos secundarios:
...
<div class="compras-configuracion-prestadores">
    ...
    <h2>Configuración de prestadores por sector y tipo de cotización</h2>

    <p class="configuracion-ayuda">
        Seleccione un sector y marque los tipos de prestador habilitados
        para cada tipo de cotización.
    </p>
                                ...
                                <tr>
                                    <td class="configuracion-check">
                                        <input type="checkbox"
                                               ...
                                               id="<portlet:namespace />tipo_prestador_<%= tipo.getIdTipoPrestacion() %>_<%= tipo.getIdTipoPrestador() %>"
                                               name="<portlet:namespace />tipo_prestador_cotizacion"
                                               value="<%= HtmlUtil.escape(tipo.getClaveConfiguracion()) %>"
                                               <%= tipo.isActivo()
                                                       ? "checked=\"checked\""
                                                       : "" %>
                                    ...
                                    <td>
                                        <%= HtmlUtil.escape(
                                                tipo.getTipoPrestacionDescripcionVisible()
                                        ) %>
                                    </td>

                                    <td>
                                        <label for="<portlet:namespace />tipo_prestador_<%= tipo.getIdTipoPrestacion() %>_<%= tipo.getIdTipoPrestador() %>">
                                            <%= HtmlUtil.escape(
