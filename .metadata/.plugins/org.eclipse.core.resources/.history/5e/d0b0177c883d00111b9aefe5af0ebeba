...
public class ReintegroServiceImpl {
	 ...
	 * del reintegro, en caso de no encontrarla arroja excepci�n
	 * 
	 * @throws SystemException
	 * @throws NoSuchReintegroEntryException
	 */
	 ...
	 * clave primaria del reintegro, en caso de no encontrarla arroja excepci�n
	 * 
	 * @throws SystemException
	 * @throws NoSuchReintegroEntryException
	 */
	 ...
	 * ortopedia y ortodoncia a partir del numero de reintegro que est� en la
	 * cuota como id_cuota
	 * 
	 * @throws SystemException
	 * @throws NoSuchReintegroEntryException
	...
	/**
	 * metodo que carga un nuevo afiliado a partir de los par�metros")); si no
	...
	/**
	 * metodo que carga una nueva prestacion a partir de los par�metros si no lo
	...
	public int cargaReintegroPrestacionEntry(String cuilTitular, int inte, int idReintegro, String cuit, String descripcion, 
		...
		CallableStatement stmt = null;
		// TEMPORAL, el plan por ahora es uno siempre, en la soluci�n final
		// deber�amos incorporar una cartilla
		int idPlan = 1;
	 ...
	 * par�metros si no lo puede insertar retorna null
	 * 
	 * @param periodo
	 * 
	 * @throws DuplicateReintegroIdException
	...
	public void cargaReintegroPrestacionOdoProtesisEntry(String cuilTitular, int inte, int idReintegro, String cuit, String descripcion, 
		...
		try {	
			...
			_log.error("Error al cargar prestacion para reintegro de pr�tesis",e);
			if (e.getSQLState().equalsIgnoreCase(WebKeysGlobal.SQL_STATE_DUPLICATE_KEY)) {
				throw new DuplicateReintegroPrestacionIdException(e);
			} else {
				throw new SystemException(e);
	 ...
	 * los par�metros si no lo puede insertar retorna null
	 * 
	 * @param periodo
	 * 
	 * @throws DuplicateReintegroIdException
	...
	/**
	 * metodo que carga una nueva prestacion de protesis de odontolog�a a partir
	 * de los par�metros si no lo puede insertar retorna null
	 * 
	 * @param periodo
	 * 
	 * @throws DuplicateReintegroIdException
	...
	/**
	 * metodo que carga una nueva prestacion de or de odontolog�a a partir de
	 * los par�metros si no lo puede insertar retorna null
	 * 
	 * @param periodo
	 * 
	...
	/**
	 * metodo que actualiza un afiliado a partir de los par�metros , si no lo
	...
	/**
	 * Metodo que aplica borrado l�gico de un reintegro a partir de la clave
	 * primaria, no borra el reintegro f�sicamente, solo lo da de baja
	 * 
	 * @throws NoSuchReintegroEntryException
	 * @throws SystemException
	 */
	...
	/**
	 * Metodo que aplica borrado l�gico de un reintegro prestacion a partir de
	 * la clave primaria, borra la prestacion f�sicamente
	 * 
	...
	/**
	 * Metodo que aplica borrado f�sico de un reintegro prestacion de protesis
	...
	public List<Reintegro> getHistoricoPrestacionesOdoProtesis(
		...
		try {
			...
			_log.error("Error al buscar hist�rico de protesis", e);
			throw new SystemException(e);
		} finally {
			ConnectionHelper.cerrar(stmt, con);
		}
	 ...
	 * par�metro, la guarda en estado default
	 * 
	 * @throws SystemException
	 */
	 ...
	 * en el par�metro, la guarda en estado default
	 * 
	 * @throws SystemException
	 */
	...
	/**
	 * Metodo que aplica borrado f�sico de una cuota de un reintegro
	 * 
	 * @throws NoSuchReintegroEntryException
	 * @throws SystemException
	 */
	...
	public ReintegroPrestacionNormal recuperaReintegrosUltimaProtesisDental(String origen,String cuilTitular, int inte, 
		...
		try {
			...
			_log.error("Error al traer ultima prestaci�n ", e);
			throw new SystemException(e);
		} finally {
			ConnectionHelper.cerrar(stmt, con);
		}
