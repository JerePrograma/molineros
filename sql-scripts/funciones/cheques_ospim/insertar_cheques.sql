DROP FUNCTION insertar_cheques(p_nro_cheque integer,
...
CREATE OR REPLACE FUNCTION insertar_cheques(p_nro_cheque numeric,
 p_cuit character varying,
 p_a_nombre_de character varying,
 p_fecha timestamp without time zone,
 p_importe numeric,
