CREATE OR REPLACE FUNCTION listado_baja_parcial_periodo(id_tercerizadora_v character varying,
 baja_fecha_desde date,
 baja_fecha_hasta date) 
RETURNS SETOF lista_baja_parcial_periodo
    LANGUAGE plpgsql
    AS $BODY$
BEGIN
--BAJAS PARCIALES
...
ALTER FUNCTION public.listado_baja_parcial_periodo(id_tercerizadora_v character varying, baja_fecha_desde date, baja_fecha_hasta date) OWNER TO postgres;
