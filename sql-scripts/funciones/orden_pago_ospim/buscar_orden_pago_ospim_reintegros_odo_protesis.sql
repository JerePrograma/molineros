CREATE OR REPLACE FUNCTION buscar_orden_pago_ospim_reintegros_odo_protesis(IN id_lista integer)
  ...
  rp_fecha_prestacion timestamp without time zone, rp_cantidad numeric, rp_importe numeric, 
  ...
  a_naci_fecha date, a_id_estado_civil integer, a_civil_esta character varying, a_id_parentesco_sss integer, a_parentesco character varying, a_ingre_fecha date, 
...
from  lista_reintegro_pago_detalle oppr, reintegro r, reintegro_prestacion_odo_protesis rp
where 
