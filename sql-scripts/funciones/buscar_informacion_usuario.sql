...
CREATE OR REPLACE FUNCTION buscar_informacion_usuario(IN p_fecha_ini timestamp without time zone, IN p_fecha_fin timestamp without time zone, IN p_id_tarjeta_acceso character varying)
