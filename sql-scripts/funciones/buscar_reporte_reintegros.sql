CREATE OR REPLACE FUNCTION buscar_reporte_reintegros(IN id_reporte integer)
  ...
  rp_modi_fecha timestamp without time zone, rp_modi_usr character varying, rp_codigo character varying, 
...
from  lista_reintegro_reporte_detalle oppr, reintegro r, reintegro_prestacion rp
where 
