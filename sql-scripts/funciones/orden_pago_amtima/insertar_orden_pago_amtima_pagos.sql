...
create or replace function insertar_orden_pago_amtima_pagos(
...
insert into orden_pago_amtima_pagos (id_orden_pago, id_punto_venta_antic, compro_tipo_antic, compro_nro_antic, cuit_antic, compro_letra_antic,
