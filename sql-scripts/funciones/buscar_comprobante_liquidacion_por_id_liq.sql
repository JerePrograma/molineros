DROP FUNCTION buscar_comprobante_liquidacion_por_id_liq(IN id_liquidacion integer);
CREATE OR REPLACE FUNCTION buscar_comprobante_liquidacion_por_id_liq(IN id_liquidacion integer)
  RETURNS TABLE(
