CREATE OR REPLACE FUNCTION autorizaciones.trae_autorizacion_pmi(IN fecha date, IN cuil_titular character varying, IN inte integer, IN autorizacion bigint)
...
and ($4 is null or ($4 is not null and aut.id_autorizacion_pmi=$4))
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION autorizaciones.trae_autorizacion_pmi(date, character varying, integer, bigint)
  OWNER TO postgres;
