CREATE OR REPLACE FUNCTION anular_comprobante(c_pto_venta integer, c_compro_tipo character varying, c_compro_nro character varying,
...
update comprobante set baja_fecha = case when p_borrar = true then localtimestamp else null end, 
...
where id_punto_venta = $1 and compro_tipo =$2 and compro_nro =$3 and
 trim(compro_letra) = trim($4) and compro_sucu =$5 and c_cuit =$6;
