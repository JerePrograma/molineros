-- Function: buscar_recibo_no_os(integer)

-- DROP FUNCTION buscar_recibo_no_os(integer);

CREATE OR REPLACE FUNCTION buscar_recibo_no_os(IN p_id integer)
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION buscar_recibo_no_os(integer)
  OWNER TO postgres;
