-- Function: buscar_recibo_no_os_ingresos(integer)

-- DROP FUNCTION buscar_recibo_no_os_ingresos(integer);

CREATE OR REPLACE FUNCTION buscar_recibo_no_os_ingresos(IN p_recibo_id integer)
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION buscar_recibo_no_os_ingresos(integer)
  OWNER TO postgres;
