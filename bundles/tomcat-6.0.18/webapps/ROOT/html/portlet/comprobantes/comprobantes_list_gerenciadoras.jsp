		   ...
		   <tr>			
			...
			<td>
					<select id="<portlet:namespace />sector" name="<portlet:namespace />sector">
						<option value="Gerenciadoras">Gerenciadoras</option>	
				    </select>
			</td>
    ...
    <table>	
		...
		<fieldset class="block-labels">
			...
			<div align="center" id="<portlet:namespace />busquedaComprobDiv">
				<liferay-util:include page="/html/portlet/comprobantes/comprobantes_search_result_gerenciadoras.jsp">
...
function <portlet:namespace />buscarCptes(){		
				...
				var url = '<portlet:renderURL windowState="<%= LiferayWindowState.EXCLUSIVE.toString() %>"/>&struts_action=/<%=portlet_name%>/comprobantes_portal_proveedores_gerenciadoras';
