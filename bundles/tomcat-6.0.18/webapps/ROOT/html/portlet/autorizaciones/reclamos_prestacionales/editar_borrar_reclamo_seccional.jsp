...
<liferay-ui:icon-menu align="left">
	...
	<portlet:renderURL windowState="<%= LiferayWindowState.MAXIMIZED.toString() %>" var="editURL">
		<portlet:param name="struts_action" value="/autorizaciones/editar_reclamosprestaciones_seccional_entry" />		
		<portlet:param name="id_reclamosel" value="<%= id %>" />
		<portlet:param name="<%=Constants.CMD %>" value="<%=Constants.EDIT %>" />
		<portlet:param name="<%= Constants.ACTION %>" value="<%=WebKeysAutorizaciones.RECLAMO_PRESTACIONAL_SECCIONAL  %>" />
