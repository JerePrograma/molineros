...
try{
	...
	//offset_reg=(Integer)session.getAttribute(WebKeysAutorizaciones.FILTRO_BUSQUEDA_SITUACIONMEDICA_OFFSET_REG );     // "offset_reg"
	//total_reg =(Integer)session.getAttribute(WebKeysAutorizaciones.FILTRO_BUSQUEDA_SITUACIONMEDICA_TOTAL_REGISTROS );     // "total_registros"
	...
	offset_reg= criterioBusquedaSituacionMedica.getPagina();
	total_reg =criterioBusquedaSituacionMedica.getRegistrosTotal();
...
<table class="lfr-table">
	...
	<tr>		
		...
		<td><select name="<portlet:namespace/>pagina_sel" id="<portlet:namespace/>pagina_sel"
				onchange="javascript:<portlet:namespace />busquedaSituacionMedica();" >				
